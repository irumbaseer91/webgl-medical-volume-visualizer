...
Camera.prototype.updateMatrices = function( force )
{
...

	{
		...
		if(this.type == Camera.ORTHOGRAPHIC)
			mat4.ortho(this._projection_matrix, -this.frustum_size*this._aspect *0.5, this.frustum_size*this._aspect*0.5, -this._frustum_size*0.5, this._frustum_size*0.5, this._near, this._far);
		else
